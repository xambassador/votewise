...
export const FriendType = {
  FRIENDS: "FRIENDS",
  PENDING_USER_TO_FRIEND_REQUEST: "PENDING_USER_TO_FRIEND_REQUEST",
  PENDING_FRIEND_TO_USER_REQUEST: "PENDING_FRIEND_TO_USER_REQUEST"
} as const;
export type FriendType = (typeof FriendType)[keyof typeof FriendType];
