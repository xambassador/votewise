...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>((props, ref) => {
  ...
  return (
    <textarea
      ...
      ref={ref}
      className={cn(
        "px-5 pt-4 pb-2 bg-nobelBlack-100 border min-h-32 border-nobelBlack-200 text-gray-300 rounded-lg placeholder:text-gray-500 resize-none text-sm sm:text-base",
        inputWrapper.focus,
