...
export const jwtService = new JWTService({ refreshTokenSecret: "secret", accessTokenSecret: "secret" });
...
export const rid = jwtService.signRid({ email: user.email, verification_code: verificationCode });
export const invalidRid = jwtService.signRid({ email: user.email, verification_code: invalidVerificationCode });
