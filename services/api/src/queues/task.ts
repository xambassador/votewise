...
import type { ITaskWorker, JobType, Tasks } from "@votewise/types";

import { Queue, Worker } from "bullmq";

import { tasksQueueDefaultJobOptions, tasksQueueName } from "@votewise/constant/queue";
...
export class TasksQueue {
  ...
  public initWorker(ctx: AppContext) {
    ...
    const emailProcessor = new EmailWorker({
      mailer: ctx.mailer,
      logger: ctx.logger,
